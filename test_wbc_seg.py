...
parser.add_argument('--imgs_test_path', '-iv', type=str, default='/mnt/ai2019/zxg_FZU/dataset/zxg_wbc_seg/seg/test/images/', help='imgs val data path.')
parser.add_argument('--labels_test_path', '-lv', type=str, default='/mnt/ai2019/zxg_FZU/dataset/zxg_wbc_seg/seg/test/masks/', help='labels val data path.')
...
result_path='/mnt/ai2019/zxg_FZU/dataset/H_Net_result/wbc/resnet/H_Net_resnet34_double_v137_hy46/'
result_roc_path='/mnt/ai2019/zxg_FZU/dataset/H_Net_result/wbc/resnet/H_Net_resnet34_double_v137_hy46_roc/'
...
net.load_state_dict(torch.load('/mnt/ai2019/zxg_FZU/seg_and_cls_projects/my_secode_paper_source_code/checkpoint/H_Net/wbc/wbc_H_Net_resnet34_double_v137_hy46.pth')['net'], strict=True)
